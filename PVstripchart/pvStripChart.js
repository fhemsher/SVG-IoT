...
function buildInitData()
{
     for(var k=0;k<100;k++)
     {
  		  var af1= (Math.random() * 30 + 700).toFixed(2)
  		  var af2= (Math.random() * 10 + 300).toFixed(2)
  		  var af3= (Math.random() * 10 + 400).toFixed(2)
  		  var afDiff=(af1-af2-af3).toFixed(0)

          var stp= (Math.random() * 0.005-.02).toFixed(3)

          var stpSet=-.02

          myValue.value+="{AF1:"+af1+",AF2:"+af2+",AF3:"+af3+",AFdiff:"+afDiff+",STP:"+stp+",STPset:"+stpSet+"},\n"
